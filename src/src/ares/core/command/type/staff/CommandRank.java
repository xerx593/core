...
public class CommandRank extends CoreCommand
{
	public CommandRank()
	{
		super("rank", new String[] {}, 2, Rank.ADMIN, "<player> <rank>");
	}
	...
	protected void prepare()
	{
		if (!isSenderPlayer())
		{
			...
			try
			{
				...
				target.getManager().setRank(updateRank, true);
			}
			catch (IllegalArgumentException invalid)
			{
				Main.error(getClass().getSimpleName(), "Rank could not be converted: " + rank + ".");
			}
