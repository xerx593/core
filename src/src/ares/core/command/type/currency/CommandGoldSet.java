...
public class CommandGoldSet extends CoreCommand
{
	public CommandGoldSet()
	{
		super("setgold", new String[] {}, 2, Rank.ADMIN, "<player> <amount>");
	}
	...
	public void execute()
	{
		...
		try
		{
			...
			target.getManager().updateCurrency(new GoldCurrency(amount), true);
		}
