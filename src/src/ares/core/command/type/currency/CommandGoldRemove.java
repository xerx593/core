...
public class CommandGoldRemove extends CoreCommand
{
	public CommandGoldRemove()
	{
		super("removegold", new String[] {}, 2, Rank.ADMIN, "<player> <amount>");
	}
	...
	public void execute()
	{
		...
		try
		{
			...
			target.removeCurrency(new GoldCurrency(amount));
		}
